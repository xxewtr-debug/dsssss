...
export const Hero: React.FC<HeroProps> = ({ onShopNow, onGoToAdmin }) => {
    return (
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0">
                    ...
                    <div className="lg:w-5/12 text-center lg:text-right order-2 lg:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                            <button 
                                onClick={onShopNow}
                                className="px-10 py-4 bg-white text-navy-950 font-black rounded-sm hover:bg-gold-500 transition-all duration-500 shadow-[0_0_40px_rgba(255,255,255,0.15)] hover:shadow-[0_0_80px_rgba(212,175,55,0.5)] flex items-center justify-center gap-3 group text-base sm:text-lg tracking-wide relative overflow-hidden"
                            >
                                <span className="relative z-10">تسوق الان</span>
                        ...
                        <div className="mt-8 flex justify-center lg:justify-start">
                            <button 
                                onClick={onGoToAdmin}
                                className="px-5 py-2 rounded-full border border-red-500/30 bg-red-500/10 text-red-400 text-xs font-bold hover:bg-red-500 hover:text-white transition-all flex items-center gap-2"
                            >
