                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/5 pb-12 text-right">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <ul className="space-y-4 text-sm text-slate-400 w-full">
                                    ...
                                    <li onClick={() => navigate('about')} className="hover:text-gold-500 cursor-pointer transition-colors flex items-center gap-2 group">
                                        <ArrowLeft size={14} className="opacity-0 group-hover:opacity-100 transition-opacity text-gold-500" />
                                        عن الشركة
                                    </li>
                                </ul>
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <ul className="space-y-4 text-sm text-slate-400">
                                    ...
                                    <li className="flex items-center gap-3">
                                        <span className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-gold-500">✉️</span>
                                        info@murtada.com
                                    </li>
                                </ul>
                            </div>
